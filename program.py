...
# We have to separate real building facade images from the architecture label images
...
# Plot a sample of the input ande real images:
...
# Build the generator
# The generator is a modified U-Net. A U-Net consist of an encoder (downsampler) and decoder (unsampler)
# Each block in the encoder is: Convolution -> Batch normalization -> leakyReLU
# Each block in the decoder is: Transposed convolution -> Batch normalization -> Dropout -> ReLU
...
def Generator():
    ...
    # Downsamplinh through the model
    skips = []
...
# Generate images 
# A function to plot some images during the training
...
# Training 
# For each example input fenerates an output
# The discriminator recives the input_image and the generated image as the first input. The second input is the input_image and the target_image
